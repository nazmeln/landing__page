...
var photoContainer = document.querySelector('.testemonials__slider');
var nextButton = document.querySelector('.slider__button-right');
var previousButton = document.querySelector('.slider__button-left');
var position = 0;
nextButton.addEventListener('click', nextPhoto);
previousButton.addEventListener('click', prevPhoto);

function nextPhoto() {
  var photoContainerWidth = photoContainer.clientWidth;
  var photos;
...
var bookButton = document.querySelector('.header__button');
